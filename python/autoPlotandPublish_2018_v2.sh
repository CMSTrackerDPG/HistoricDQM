...
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronPPExpressStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini --dataset StreamExpress --epoch Run2018 --epoch Commissioning2018 -r "run >= 290129" --reco Express -J json_DCSONLY_PEAK.txt &> "${LOGDIR}/expressStripPEAK.log"
...
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronPPExpressTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset StreamExpress --epoch Run2018 --epoch Commissioning2018 -r "run >= 290129" --reco Express -J json_DCSONLY.txt &> "${LOGDIR}/expressTracking.log"
...
echo "      --->>> Strip PEAK Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronPPPromptStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini --dataset ZeroBias --epoch Run2018 --epoch Commissioning2018 -r "run >= 290129" --reco Prompt -J json_DCSONLY_PEAK.txt  &> "${LOGDIR}/promptStripPEAK.log"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronPPPromptTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset ZeroBias --epoch Run2018 --epoch Commissioning2018 -r "run >= 290129" --reco Prompt -J json_DCSONLY.txt &> "${LOGDIR}/promptTracking.log"
python ./MakeRatioJSON.py -n NumberOfTrack_mean -d NumberofPVertices_mean -f TrkOverPVertices_ratio -t TrkOverPVertices_ratio
python MakeIncremental.py -h ./JSON/ -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
...
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronCExpress.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini --dataset StreamExpressCosmics --epoch Run2018 --epoch Commissioning2018 -r "run >= 290129" --reco Express -J json_DCSONLY_cosmics_DECO.txt &> "${LOGDIR}/expressCosmicsStripDECO.log"
...
echo "      --->>> Pixel Started at ${subT}"
rm -rf ./JSON/*
python trendPlots_2018.py -C cfg/trendPlotsDQM_cronCExpressPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset StreamExpressCosmics --epoch Run2018 --epoch Commissioning2018 -r "run>=292505" --reco Express -J json_DCSONLY_cosmics.txt  &> "${LOGDIR}/expressCosmicsPixel.log"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronCExpressTracking.ini -C cfg/trendPlotsTrackingCosmics.ini --dataset StreamExpressCosmics --epoch Run2018 --epoch Commissioning2018 -r "run > 292505" --reco Express -J json_DCSONLY_cosmics.txt  &> "${LOGDIR}/expressCosmicsTracking.log"
...
echo "      --->>> Strips DECO Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini --dataset Cosmics --epoch Run2018 --epoch Commissioning2018 -r "run >= 290129" --reco Prompt -J json_DCSONLY_cosmics_DECO.txt &> "${LOGDIR}/promptCosmicsStripsDECO.log"
...
echo "      --->>> Pixel Started at ${subT}"
rm -rf ./JSON/*
python trendPlots_2018.py -C cfg/trendPlotsDQM_cronCPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset Cosmics --epoch Run2018 --epoch Commissioning2018 -r "run>=292505" --reco Prompt -J json_DCSONLY_cosmics.txt &> "${LOGDIR}/promptCosmicsPixel.log"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018.py -C cfg/trendPlotsDQM_cronCPromptTracking.ini  -C cfg/trendPlotsTrackingCosmics.ini --dataset Cosmics --epoch Run2018 --epoch Commissioning2018 -r "run >= 292505" --reco Prompt -J json_DCSONLY_cosmics.txt &> "${LOGDIR}/promptCosmicsTracking.log"
