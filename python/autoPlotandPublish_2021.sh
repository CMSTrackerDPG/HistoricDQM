...
LOGDIR="/home/dpgtkdqm/HDQM/CMSSW_11_3_4/HistoricDQM/Logs"
...
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronPPExpressStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini --dataset StreamExpress --dataset StreamHIExpress --epoch Commissioning2021 --epoch Run2021 -r "run >= 342682" --reco Express -J json_DCSONLY_PEAK.txt &> "${LOGDIR}/expressStripPEAK.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpress/Strips/PEAK/
touch .doneStreamExpress
subT=`date`
...
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpress/Strips/ALL/
touch .doneStreamExpress
subT=`date`
...
#rm -rf ./JSON/*
#python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronPPExpressStrips.ini -C cfg/trendPlotsStrip_GainsAAG.ini --dataset StreamExpress --dataset StreamHIExpress --epoch Commissioning2021 --epoch Run2021 -r "run >= 342682" --reco PromptCalibProdSiStripGainsAAG-Express --datatier ALCAPROMPT -J json_DCSONLY_DECO.txt  &> "${LOGDIR}/expressStripGAIN.log"
#cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpress/Strips/DECO/
touch .doneStreamExpress
subT=`date`
...
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronPPExpressTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset StreamExpress --dataset StreamHIExpress --epoch Commissioning2021 --epoch Run2021 -r "run >= 342682" --reco Express -J json_DCSONLY.txt &> "${LOGDIR}/expressTracking.log"
...
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpress/Tracking/
...
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronPPExpressRecoErrors.ini -C cfg/trendPlotsRECOErrors2017.ini --dataset StreamExpress --dataset StreamHIExpress --epoch Commissioning2021 --epoch Run2021 -J json_DCSONLY.txt --reco Express &> "${LOGDIR}/expressRECOerrors.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpress/RecoErrors/
...
echo "      --->>> Strip ALL Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronPPPromptStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  -C cfg/trendPlotsStrip_StoN_TOB.ini  -C cfg/trendPlotsStrip_StoN_TIB.ini -C cfg/trendPlotsStrip_StoN_TEC_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TEC_MINUS.ini -C cfg/trendPlotsStrip_StoN_TID_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TID_MINUS.ini -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini --dataset ZeroBias --dataset HIMinimumBias0 --epoch Run2018 --epoch Commissioning2018 --epoch HIRun2018 -r "run >= 342682" --reco Prompt -J json_DCSONLY.txt &> "${LOGDIR}/promptStripALL.log"
python ./HDQMInefficientModules.py
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/ZeroBias/Strips/ALL/
touch .doneZeroBias
subT=`date`
echo "      --->>> Strip ALL Ended at ${subT}"
...
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/ZeroBias/PixelPhase1/
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronPPPromptTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset ZeroBias --dataset HIMinimumBias0 --epoch Run2018 --epoch Commissioning2018 --epoch HIRun2018 -r "run >= 342682" --reco Prompt -J json_DCSONLY.txt &> "${LOGDIR}/promptTracking.log"
python ./MakeRatioJSON.py -n NumberOfTrack_mean -d NumberofPVertices_mean -f TrkOverPVertices_ratio -t TrkOverPVertices_ratio
python MakeIncremental.py -h ./JSON/ -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/ZeroBias/Tracking/
...
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/ZeroBias/RecoErrors/ 
...
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpressCosmics/Strips/PEAK/
touch .doneStreamExpressCosmics
subT=`date`
...
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpressCosmics/Strips/ALL/
touch .doneStreamExpressCosmics
subT=`date`
...
echo "      --->>> Pixel Started at ${subT}"
rm -rf ./JSON/*
python trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronCExpressPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset StreamExpressCosmics --epoch Commissioning2021 --epoch Run2021 -r "run>=292505" --reco Express -J json_DCSONLY_cosmics.txt  &> "${LOGDIR}/expressCosmicsPixel.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpressCosmics/PixelPhase1/
touch .doneStreamExpressCosmics
subT=`date`
echo "      --->>> Pixel Ended at ${subT}"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronCExpressTracking.ini -C cfg/trendPlotsTrackingCosmics.ini --dataset StreamExpressCosmics --epoch Commissioning2021 --epoch Run2021 -r "run > 292505" --reco Express -J json_DCSONLY_cosmics.txt  &> "${LOGDIR}/expressCosmicsTracking.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpressCosmics/Tracking
python MakeIncremental.py -h /data061/users/event_display/HDQM/v4/alljsons/2021/StreamExpressCosmics/Tracking/ -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
...
echo "      --->>> Strips DECO Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  --dataset Cosmics --epoch Commissioning2021 --epoch Run2021 -r "run >= 342682" --reco Prompt -J json_DCSONLY_cosmics_DECO.txt &> "${LOGDIR}/promptCosmicsStripsDECO.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/Cosmics/Strips/DECO/
touch .doneCosmics
subT=`date`
echo "      --->>> Strips DECO Ended at ${subT}"
...
echo "      --->>> Strips PEAK Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  --dataset Cosmics --epoch Commissioning2021 --epoch Run2021 -r "run >= 342682" --reco Prompt -J json_DCSONLY_cosmics_PEAK.txt &> "${LOGDIR}/promptCosmicsStripsPEAK.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/Cosmics/Strips/PEAK/
touch .doneCosmics
subT=`date`
echo "      --->>> Strips PEAK Ended at ${subT}"
...
echo "      --->>> Strips ALL Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  --dataset Cosmics --epoch Commissioning2021 --epoch Run2021 -r "run >= 342682" --reco Prompt -J json_DCSONLY_cosmics.txt &> "${LOGDIR}/promptCosmicsStripsALL.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/Cosmics/Strips/ALL/
touch .doneCosmics
subT=`date`
echo "      --->>> Strips ALL Ended at ${subT}"
...
echo "      --->>> Pixel Started at ${subT}"
rm -rf ./JSON/*
python trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronCPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset Cosmics --epoch Commissioning2021 --epoch Run2021 -r "run>=292505" --reco Prompt -J json_DCSONLY_cosmics.txt &> "${LOGDIR}/promptCosmicsPixel.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/Cosmics/PixelPhase1/
touch .doneCosmics
subT=`date`
echo "      --->>> Pixel Ended at ${subT}"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python ./trendPlots_2018_HI.py -C cfg/trendPlotsDQM_cronCPromptTracking.ini  -C cfg/trendPlotsTrackingCosmics.ini --dataset Cosmics --epoch Commissioning2021 --epoch Run2021 -r "run >= 292505" --reco Prompt -J json_DCSONLY_cosmics.txt &> "${LOGDIR}/promptCosmicsTracking.log"
cp ./JSON/* /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/Cosmics/Tracking
python MakeIncremental.py -h /data061/users/event_display/HDQM/v4/alljsons/2021/Prompt/Cosmics/Tracking/ -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
