...
#Cosmics STRIPS
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini --dataset Cosmics --epoch Run2017 -r "run >= 290129" --reco Prompt -J json_DCSONLY_cosmics_DECO.txt
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/Prompt/Cosmics/Strips/DECO/
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/Prompt/Cosmics/Strips/DECO/
touch .doneCosmics

rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini --dataset Cosmics --epoch Run2017 -r "run >= 290129" --reco Prompt -J json_DCSONLY_cosmics_PEAK.txt
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/Prompt/Cosmics/Strips/PEAK/
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/Prompt/Cosmics/Strips/PEAK/
touch .doneCosmics

rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini --dataset Cosmics --epoch Run2017 -r "run >= 290129" --reco Prompt -J json_DCSONLY_cosmics_DECO.txt
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/Prompt/Cosmics/Strips/DECO/
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/Prompt/Cosmics/Strips/DECO/
touch .doneCosmics
...
#rm -rf ./JSON/*
#python trendPlots.py -C cfg/trendPlotsDQM_cronCPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clusters.ini --dataset Cosmics --epoch Commissioning2017 -r "run>=292505" --reco Prompt -J json_DCSONLY_cosmics.txt
...
#Cosmics PIXEL
rm -rf ./JSON/*
python trendPlots.py -C cfg/trendPlotsDQM_cronCPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clusters.ini --dataset Cosmics --epoch Run2017 -r "run>=292505" --reco Prompt -J json_DCSONLY_cosmics.txt
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/Prompt/Cosmics/PixelPhase1/
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/Prompt/Cosmics/PixelPhase1/
touch .doneCosmics
...
#Cosmics Tracking
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCPromptTracking.ini  -C cfg/trendPlotsTrackingCosmics.ini --dataset Cosmics --epoch Run2017 -r "run >= 292505" --reco Prompt -J json_DCSONLY_cosmics.txt
...
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCExpress.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini --dataset StreamExpressCosmics --epoch Run2017 -r "run >= 290129" --reco Express -J json_DCSONLY_cosmics_DECO.txt
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/StreamExpressCosmics/Strips/DECO/
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/StreamExpressCosmics/Strips/DECO/
touch .doneStreamExpressCosmics

rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCExpress.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini --dataset StreamExpressCosmics --epoch Run2017 -r "run >= 290129" --reco Express -J json_DCSONLY_cosmics_PEAK.txt
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/StreamExpressCosmics/Strips/PEAK/
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/StreamExpressCosmics/Strips/PEAK/
touch .doneStreamExpressCosmics

rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCExpress.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini --dataset StreamExpressCosmics --epoch Run2017 -r "run >= 290129" --reco Express -J json_DCSONLY_cosmics_DECO.txt
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/StreamExpressCosmics/Strips/DECO/
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/StreamExpressCosmics/Strips/DECO/
touch .doneStreamExpressCosmics
...
#rm -rf ./JSON/*
#python trendPlots.py -C cfg/trendPlotsDQM_cronCExpressPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clusters.ini --dataset StreamExpressCosmics --epoch Commissioning2017 -r "run>=292505" --reco Express -J json_DCSONLY_cosmics.txt
...
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronCExpressTracking.ini -C cfg/trendPlotsTrackingCosmics.ini --dataset StreamExpressCosmics --epoch Run2017 -r "run > 292505" --reco Express -J json_DCSONLY_cosmics.txt
...
#ZeroBias PIXEL
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronPPPromptPixel.ini -C cfg/trendPlotsPixelPhase1_clustersV2.ini -C cfg/trendPlotsPixelPhase1_FED.ini --dataset ZeroBias --epoch Run2017 -r "run >= 292505" --reco Prompt -J json_DCSONLY.txt
...
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronPPPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_BPIX_Residuals.ini -C cfg/trendPlotsPixelPhase1_FPIX_Residuals.ini --dataset ZeroBias --epoch Run2017 -r "run >= 292505" --reco Prompt -J json_DCSONLY.txt
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/Prompt/ZeroBias/PixelPhase1/
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/Prompt/ZeroBias/PixelPhase1/
touch .doneZeroBiasPixel
...
#StreamExpress PIXEL
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronPPExpressPixel.ini -C cfg/trendPlotsPixelPhase1_clustersV2.ini -C cfg/trendPlotsPixelPhase1_FED.ini --dataset StreamExpress --epoch Run2017 -r "run >= 292505" --reco Express -J json_DCSONLY.txt
...
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronPPExpressPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_BPIX_Residuals.ini -C cfg/trendPlotsPixelPhase1_FPIX_Residuals.ini --dataset StreamExpress --epoch Run2017 -r "run >= 292505" --reco Express -J json_DCSONLY.txt
cp ./JSON/* /data/users/event_display/HDQM/v2/alljsons/2017/StreamExpress/PixelPhase1/
cp ./JSON/* /data/users/event_display/HDQM/v3/alljsons/2017/StreamExpress/PixelPhase1/
touch .doneStreamExpressPixel
...
rm -rf ./JSON/*
python ./trendPlots.py -C cfg/trendPlotsDQM_cronPPExpressTracking.ini -C cfg/trendPlotsTracking.ini --dataset StreamExpress --epoch Run2017 -r "run >= 290129" --reco Express -J json_DCSONLY.txt
python ./MakeRatioJSON.py -n NumberOfTrack_mean -d NumberofPVertices_mean -f TrkOverPVertices_ratio -t TrkOverPVertices_ratio
