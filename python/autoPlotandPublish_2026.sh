...
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPExpressStrips.ini -C cfg/trendPlotsStrip_GainsAAG.ini -C cfg/trendPlotsStrip_GainsAAG_Langau.ini --dataset StreamExpress --dataset StreamHIExpress --dataset StreamHIExpressRawPrime --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run >= ${FIRST_COLLISIONS}" --reco PromptCalibProdSiStripGainsAAG-Express --datatier ALCAPROMPT -J "${DCSONLY}/json_DCSONLY_DECO.txt"  &> "${LOGDIR}/expressStripGAIN.log"
cp ./JSON/* "${OUTDIR}/alljsons/${YEAR}/StreamExpress/Strips/DECO/"
touch .doneStreamExpress
subT=`date`
...
#rm -rf ./JSON/*
#python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPExpressPixel_2.ini -C cfg/trendPlotsPixelPhase1_DamagedL2Module.ini -C cfg/trendPlotsPixelPhase1_DamagedL4Module.ini -C cfg/trendPlotsPixelPhase1_DamagedL3Module.ini -C cfg/trendPlotsPixelPhase1_DamagedRing2Module.ini -C cfg/trendPlotsPixelPhase1_DamagedRing1Module.ini --dataset StreamExpress --dataset StreamHIExpressRawPrime --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run >= ${FIRST_COLLISIONS}" --reco Express -J "${DCSONLY}/json_DCSONLY.txt"  &> "${LOGDIR}/expressPixel_2.log"
#cp ./JSON/* "${OUTDIR}/alljsons/${YEAR}/StreamExpress/PixelPhase1/"
...
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPExpressTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset StreamExpress --dataset StreamHIExpressRawPrime --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run >= ${FIRST_COLLISIONS}" --reco Express -J "${DCSONLY}/json_DCSONLY.txt" &> "${LOGDIR}/expressTracking.log"
...
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPHLTTracking.ini -C cfg/trendPlotsHLTTracking.ini -C cfg/trendPlotsHLT_Alignment.ini --dataset StreamHLTMonitor --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" --epoch Commissioning"${YEAR}" -r "run >= ${FIRST_COLLISIONS}" --reco Express -J "${DCSONLY}/json_DCSONLY.txt" &> "${LOGDIR}/expressHLTTracking.log"
...
#rm -rf ./JSON/*
#python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPExpressRecoErrors.ini -C cfg/trendPlotsRECOErrors2017.ini --dataset StreamExpress --dataset StreamHIExpressRawPrime --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -J "${DCSONLY}/json_DCSONLY.txt" --reco Express &> "${LOGDIR}/expressRECOerrors.log"
...
echo "      --->>> Strip DECO Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  -C cfg/trendPlotsStrip_StoN_TOB.ini  -C cfg/trendPlotsStrip_StoN_TIB.ini -C cfg/trendPlotsStrip_StoN_TEC_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TEC_MINUS.ini -C cfg/trendPlotsStrip_StoN_TID_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TID_MINUS.ini -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini -C cfg/trendPlotsStrip_ClustersNoise_TOB.ini -C cfg/trendPlotsStrip_ClustersNoise_TIB.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_MINUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_MINUS.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" --epoch Commissioning"${YEAR}" -r "run >= ${FIRST_COLLISIONS}" --reco Prompt -J "${DCSONLY}/json_DCSONLY_DECO.txt" &> "${LOGDIR}/promptStripDECO.log"
...
#echo "      --->>> Pixel part_2 Started at ${subT}"
#rm -rf ./JSON/*
#python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptPixel_2.ini -C cfg/trendPlotsPixelPhase1_DamagedL2Module.ini -C cfg/trendPlotsPixelPhase1_DamagedL4Module.ini -C cfg/trendPlotsPixelPhase1_DamagedL3Module.ini -C cfg/trendPlotsPixelPhase1_DamagedRing2Module.ini -C cfg/trendPlotsPixelPhase1_DamagedRing1Module.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" --epoch Commissioning"${YEAR}" -r "run >= ${FIRST_COLLISIONS}" --reco Prompt -J "${DCSONLY}/json_DCSONLY.txt"  &> "${LOGDIR}/promptPixel_2.log"
#cp ./JSON/* "${OUTDIR}/alljsons/${YEAR}/Prompt/ZeroBias/PixelPhase1/"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" --epoch Commissioning"${YEAR}" -r "run >= ${FIRST_COLLISIONS}" --reco Prompt -J "${DCSONLY}/json_DCSONLY.txt" &> "${LOGDIR}/promptTracking.log"
python3 ./MakeRatioJSON.py -n NumberOfTrack_mean -d NumberofPVertices_mean -f TrkOverPVertices_ratio -t TrkOverPVertices_ratio
python3 MakeIncremental.py -h ./JSON/ -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
...
#echo "      --->>> RecoErrors Started at ${subT}"
#rm -rf ./JSON/*
#python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptRecoErrors.ini -C cfg/trendPlotsRECOErrors2017.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" --epoch Commissioning"${YEAR}" -J "${DCSONLY}/json_DCSONLY.txt" --reco Prompt &> "${LOGDIR}/promptRECOerrors.log"
...
rm -rf ./JSON/*
python3 trendPlots_2022.py -C cfg/trendPlotsDQM_cronCExpressPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset StreamExpressCosmics --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run > ${FIRST_COSMICS}"  --reco Express -J "${DCSONLY}/json_DCSONLY_cosmics.txt"  &> "${LOGDIR}/expressCosmicsPixel.log"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCExpressTracking.ini -C cfg/trendPlotsTrackingCosmics.ini --dataset StreamExpressCosmics --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run > ${FIRST_COSMICS}" --reco Express -J "${DCSONLY}/json_DCSONLY_cosmics.txt"  &> "${LOGDIR}/expressCosmicsTracking.log"
...
echo "      --->>> Strips DECO Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  --dataset Cosmics --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run >= ${FIRST_COSMICS}" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics_DECO.txt" &> "${LOGDIR}/promptCosmicsStripsDECO.log"
...
echo "      --->>> Pixel Started at ${subT}"
rm -rf ./JSON/*
python3 trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset Cosmics --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run >= ${FIRST_COSMICS}" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics.txt" &> "${LOGDIR}/promptCosmicsPixel.log"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPromptTracking.ini  -C cfg/trendPlotsTrackingCosmics.ini --dataset Cosmics --epoch Commissioning"${YEAR}" --epoch Run"${YEAR}" --epoch HIRun"${YEAR}" --epoch pORun"${YEAR}" --epoch OORun"${YEAR}" --epoch NeNeRun"${YEAR}" -r "run >= ${FIRST_COSMICS}" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics.txt" &> "${LOGDIR}/promptCosmicsTracking.log"
