...
#                print "Mean Denominator = ",Mean_Den, " with error = ", Mean_Den_err
    ...
    outfile=open(pathjson+dataset+"/"+json_outfile+".json", 'w')
...
# Read command line args
    myopts, args = getopt.getopt(sys.argv[1:],"s:n:d:f:t:")
...
#    print ("Numeraror File : %s and  Denominator File: %s" % (json_infile1,json_infile2) )
    ...
    MakeRatio(dataset,json_infile1,json_infile2,json_outfile,plot_outtitle)
