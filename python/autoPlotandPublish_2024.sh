...
python3 ./dcsonly_2022.py -c Cosmics24 -m 376823 -f
subT=`date`
echo "      --->>> Cosmics Run List generation ended at ${subT}"
cp Run_LHCFill_RunDuration_Cosmics.json "${OUTDIR}/alljsons/2024/"
subT=`date`
echo "      --->>> Start Collisions Run List generation at ${subT}"
python3 ./dcsonly_2022.py -c Collisions24 -m 378237 -f
subT=`date`
echo "      --->>> Collisions Run List generation ended at ${subT}"
cp Run_LHCFill_RunDuration.json "${OUTDIR}/alljsons/2024/"
...
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpress/Strips/PEAK/"
touch .doneStreamExpress
subT=`date`
...
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpress/Strips/ALL/"
touch .doneStreamExpress
subT=`date`
...
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPExpressTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset StreamExpress --dataset StreamHIExpressRawPrime --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run >= 376824" --reco Express -J "${DCSONLY}/json_DCSONLY.txt" &> "${LOGDIR}/expressTracking.log"
...
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpress/Tracking/"
...
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPHLTTracking.ini -C cfg/trendPlotsHLTTracking.ini -C cfg/trendPlotsHLT_Alignment.ini --dataset StreamHLTMonitor --epoch Run2024 --epoch HIRun2024 --epoch Commissioning2024 -r "run >= 376824" --reco Express -J "${DCSONLY}/json_DCSONLY.txt" &> "${LOGDIR}/expressHLTTracking.log"
...
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamHLTMonitor/Tracking/"
...
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPExpressRecoErrors.ini -C cfg/trendPlotsRECOErrors2017.ini --dataset StreamExpress --dataset StreamHIExpressRawPrime --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -J "${DCSONLY}/json_DCSONLY.txt" --reco Express &> "${LOGDIR}/expressRECOerrors.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpress/RecoErrors/"
...
echo "      --->>> Strip DECO Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  -C cfg/trendPlotsStrip_StoN_TOB.ini  -C cfg/trendPlotsStrip_StoN_TIB.ini -C cfg/trendPlotsStrip_StoN_TEC_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TEC_MINUS.ini -C cfg/trendPlotsStrip_StoN_TID_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TID_MINUS.ini -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini -C cfg/trendPlotsStrip_ClustersNoise_TOB.ini -C cfg/trendPlotsStrip_ClustersNoise_TIB.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_MINUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_MINUS.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run2024 --epoch HIRun2024 --epoch Commissioning2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY_DECO.txt" &> "${LOGDIR}/promptStripDECO.log"
#python3 ./HDQMInefficientModules.py
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/ZeroBias/Strips/DECO/"
touch .doneZeroBias
subT=`date`
echo "      --->>> Strip DECO Ended at ${subT}"
...
echo "      --->>> Strip PEAK Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini -C cfg/trendPlotsStrip_ClustersNoise_TOB.ini -C cfg/trendPlotsStrip_ClustersNoise_TIB.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_MINUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_MINUS.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run2024 --epoch HIRun2024 --epoch Commissioning2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY_PEAK.txt"  &> "${LOGDIR}/promptStripPEAK.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/ZeroBias/Strips/PEAK/"
touch .doneZeroBias
subT=`date`
echo "      --->>> Strip PEAK Ended at ${subT}"
...
echo "      --->>> Strip ALL Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptStrips.ini -C cfg/trendPlotsStrip_General_2015.ini -C cfg/trendPlotsStrip_TEC_2015.ini -C cfg/trendPlotsStrip_TID_2015.ini -C cfg/trendPlotsStrip_TIB.ini -C cfg/trendPlotsStrip_TOB.ini -C cfg/trendPlotsStripG2.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_Number_APVShots.ini -C cfg/trendPlotsStrip_TIB_Residuals.ini -C cfg/trendPlotsStrip_TOB_Residuals.ini -C cfg/trendPlotsStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  -C cfg/trendPlotsStrip_StoN_TOB.ini  -C cfg/trendPlotsStrip_StoN_TIB.ini -C cfg/trendPlotsStrip_StoN_TEC_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TEC_MINUS.ini -C cfg/trendPlotsStrip_StoN_TID_PLUS.ini  -C cfg/trendPlotsStrip_StoN_TID_MINUS.ini -C cfg/trendPlotsStrip_BadComponents.ini -C cfg/trendPlotsStrip_FEerror.ini -C cfg/trendPlotsStrip_ClustersNoise_TOB.ini -C cfg/trendPlotsStrip_ClustersNoise_TIB.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TID_MINUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_PLUS.ini -C cfg/trendPlotsStrip_ClustersNoise_TEC_MINUS.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run2024 --epoch HIRun2024 --epoch Commissioning2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY.txt" &> "${LOGDIR}/promptStripALL.log"
#python3 ./HDQMInefficientModules.py
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/ZeroBias/Strips/ALL/"
touch .doneZeroBias
subT=`date`
echo "      --->>> Strip ALL Ended at ${subT}"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptTracking.ini -C cfg/trendPlotsTracking.ini -C cfg/trendPlotsAlignment.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run2024 --epoch HIRun2024 --epoch Commissioning2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY.txt" &> "${LOGDIR}/promptTracking.log"
python3 ./MakeRatioJSON.py -n NumberOfTrack_mean -d NumberofPVertices_mean -f TrkOverPVertices_ratio -t TrkOverPVertices_ratio
python3 MakeIncremental.py -h ./JSON/ -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/ZeroBias/Tracking/"
...
echo "      --->>> RecoErrors Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronPPPromptRecoErrors.ini -C cfg/trendPlotsRECOErrors2017.ini --dataset ZeroBias --dataset HIPhysicsRawPrime0 --epoch Run2024 --epoch HIRun2024 --epoch Commissioning2024 --epoch HIRun2024 -J "${DCSONLY}/json_DCSONLY.txt" --reco Prompt &> "${LOGDIR}/promptRECOerrors.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/ZeroBias/RecoErrors/"
...
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpressCosmics/Strips/PEAK/"
touch .doneStreamExpressCosmics
subT=`date`
...
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpressCosmics/Strips/ALL/"
touch .doneStreamExpressCosmics
subT=`date`
...
echo "      --->>> Pixel Started at ${subT}"
rm -rf ./JSON/*
python3 trendPlots_2022.py -C cfg/trendPlotsDQM_cronCExpressPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset StreamExpressCosmics --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run>=292505" --reco Express -J "${DCSONLY}/json_DCSONLY_cosmics.txt"  &> "${LOGDIR}/expressCosmicsPixel.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpressCosmics/PixelPhase1/"
touch .doneStreamExpressCosmics
subT=`date`
echo "      --->>> Pixel Ended at ${subT}"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCExpressTracking.ini -C cfg/trendPlotsTrackingCosmics.ini --dataset StreamExpressCosmics --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run > 292505" --reco Express -J "${DCSONLY}/json_DCSONLY_cosmics.txt"  &> "${LOGDIR}/expressCosmicsTracking.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/StreamExpressCosmics/Tracking"
python3 MakeIncremental.py -h "${OUTDIR}/alljsons/2024/StreamExpressCosmics/Tracking/" -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
...
echo "      --->>> Strips DECO Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  --dataset Cosmics --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics_DECO.txt" &> "${LOGDIR}/promptCosmicsStripsDECO.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/Cosmics/Strips/DECO/"
touch .doneCosmics
subT=`date`
echo "      --->>> Strips DECO Ended at ${subT}"
...
echo "      --->>> Strips PEAK Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  --dataset Cosmics --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics_PEAK.txt" &> "${LOGDIR}/promptCosmicsStripsPEAK.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/Cosmics/Strips/PEAK/"
touch .doneCosmics
subT=`date`
echo "      --->>> Strips PEAK Ended at ${subT}"
...
echo "      --->>> Strips ALL Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPrompt.ini -C cfg/trendPlotsStrip_TotalClusterMultiplicity.ini -C cfg/trendPlotsStrip_StoN.ini -C cfg/trendPlotsStrip_StoN_mean.ini -C cfg/trendPlotsCStrip_TIB_Residuals.ini -C cfg/trendPlotsCStrip_TOB_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Minus_Residuals.ini -C cfg/trendPlotsCStrip_TEC_Plus_Residuals.ini -C cfg/trendPlotsStrip_TID_Minus_Residuals.ini -C cfg/trendPlotsStrip_TID_Plus_Residuals.ini  --dataset Cosmics --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics.txt" &> "${LOGDIR}/promptCosmicsStripsALL.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/Cosmics/Strips/ALL/"
touch .doneCosmics
subT=`date`
echo "      --->>> Strips ALL Ended at ${subT}"
...
echo "      --->>> Pixel Started at ${subT}"
rm -rf ./JSON/*
python3 trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clustersCosmics.ini -C cfg/trendPlotsPixelPhase1_tracks.ini --dataset Cosmics --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics.txt" &> "${LOGDIR}/promptCosmicsPixel.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/Cosmics/PixelPhase1/"
touch .doneCosmics
subT=`date`
echo "      --->>> Pixel Ended at ${subT}"
...
echo "      --->>> Tracking Started at ${subT}"
rm -rf ./JSON/*
python3 ./trendPlots_2022.py -C cfg/trendPlotsDQM_cronCPromptTracking.ini  -C cfg/trendPlotsTrackingCosmics.ini --dataset Cosmics --epoch Commissioning2024 --epoch Run2024 --epoch HIRun2024 -r "run >= 376824" --reco Prompt -J "${DCSONLY}/json_DCSONLY_cosmics.txt" &> "${LOGDIR}/promptCosmicsTracking.log"
cp ./JSON/* "${OUTDIR}/alljsons/2024/Prompt/Cosmics/Tracking"
python3 MakeIncremental.py -h "${OUTDIR}/alljsons/2024/Prompt/Cosmics/Tracking/" -i NumberOfALCARecoTracks -o IncrementalNumberOfALCARecoTracks -t "Incremental Number of ALCA Reco Tracks"
