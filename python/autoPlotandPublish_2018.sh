...
LOGDIR="/data/users/HDQM/CMSSW_10_0_0/HistoricDQM/Logs"
...
#Cosmics PIXEL
#rm -rf ./JSON/*
#python trendPlots_ROOTfile.py -C cfg/trendPlotsDQM_cronCPromptPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clusters.ini --dataset Cosmics --epoch Run2018 -r "run>=292505" --reco Prompt -J json_DCSONLY_cosmics.txt &> "${LOGDIR}/promptCosmicsPixel.log"
...
#Cosmics Tracking
#rm -rf ./JSON/*
#python ./trendPlots_ROOTfile.py -C cfg/trendPlotsDQM_cronCPromptTracking.ini  -C cfg/trendPlotsTrackingCosmics.ini --dataset Cosmics --epoch Run2018 -r "run >= 292505" --reco Prompt -J json_DCSONLY_cosmics.txt &> "${LOGDIR}/promptCosmicsTracking.log"
...
#rm -rf ./JSON/*
#python trendPlots_ROOTfile.py -C cfg/trendPlotsDQM_cronCExpressPixel.ini -C cfg/trendPlotsPixelPhase1_ADCDIGI.ini -C cfg/trendPlotsPixelPhase1_clusters.ini --dataset StreamExpressCosmics --epoch Run2018 -r "run>=292505" --reco Express -J json_DCSONLY_cosmics.txt  &> "${LOGDIR}/expressCosmicsPixel.log"
...
#rm -rf ./JSON/*
#python ./trendPlots_ROOTfile.py -C cfg/trendPlotsDQM_cronCExpressTracking.ini -C cfg/trendPlotsTrackingCosmics.ini --dataset StreamExpressCosmics --epoch Run2018 -r "run > 292505" --reco Express -J json_DCSONLY_cosmics.txt  &> "${LOGDIR}/expressCosmicsTracking.log"
